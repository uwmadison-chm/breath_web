...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Response.duration_ms'
        db.add_column('timing_response', 'duration_ms', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Response.duration_ms'
        db.delete_column('timing_response', 'duration_ms')
    ...
    models = {
        ...
        'timing.participant': {
            ...
            'participant_number': ('django.db.models.fields.CharField', [], {'default': "'746144'", 'unique': 'True', 'max_length': '8'}),
