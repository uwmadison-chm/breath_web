...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Response.timezone_offset_min'
        db.add_column('timing_response', 'timezone_offset_min', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'Participant.timezone_offset_min'
        db.delete_column('timing_participant', 'timezone_offset_min')


    def backwards(self, orm):
        
        # Deleting field 'Response.timezone_offset_min'
        db.delete_column('timing_response', 'timezone_offset_min')

        # Adding field 'Participant.timezone_offset_min'
        db.add_column('timing_participant', 'timezone_offset_min', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    ...
    models = {
        ...
        'timing.participant': {
            ...
            'participant_number': ('django.db.models.fields.CharField', [], {'default': "'182668'", 'unique': 'True', 'max_length': '8'}),
