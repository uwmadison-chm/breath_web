...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Experiment.last_exported_at'
        db.add_column('timing_experiment', 'last_exported_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 11, 29, 12, 25, 42, 692180), blank=True), keep_default=False)

        # Adding field 'Experiment.data_last_added_at'
        db.add_column('timing_experiment', 'data_last_added_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 11, 29, 12, 25, 51, 932044), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Experiment.last_exported_at'
        db.delete_column('timing_experiment', 'last_exported_at')

        # Deleting field 'Experiment.data_last_added_at'
        db.delete_column('timing_experiment', 'data_last_added_at')
    ...
    models = {
        ...
        'timing.experiment': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'url_slug': ('django.db.models.fields.SlugField', [], {'default': "'nqhsf'", 'unique': 'True', 'max_length': '10', 'db_index': 'True'})
        },
        'timing.gender': {
        ...
        'timing.participant': {
            ...
            'participant_number': ('django.db.models.fields.CharField', [], {'default': "'740783'", 'unique': 'True', 'max_length': '8'}),
