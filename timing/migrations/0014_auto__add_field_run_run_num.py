...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Run.run_num'
        db.add_column('timing_run', 'run_num', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Run.run_num'
        db.delete_column('timing_run', 'run_num')
    ...
    models = {
        ...
        'timing.participant': {
            ...
            'participant_number': ('django.db.models.fields.CharField', [], {'default': "'254020'", 'unique': 'True', 'max_length': '8'}),
