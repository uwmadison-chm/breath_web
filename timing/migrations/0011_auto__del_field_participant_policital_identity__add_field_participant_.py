...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Participant.political_identity'
        db.add_column('timing_participant', 'political_identity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timing.PoliticalIdentity'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Participant.political_identity'
        db.delete_column('timing_participant', 'political_identity_id')
    ...
    models = {
        ...
        'timing.participant': {
            ...
            'participant_number': ('django.db.models.fields.CharField', [], {'default': "'684934'", 'unique': 'True', 'max_length': '8'}),
