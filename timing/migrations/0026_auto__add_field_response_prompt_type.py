...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Response.prompt_type'
        db.add_column('timing_response', 'prompt_type',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Response.prompt_type'
        db.delete_column('timing_response', 'prompt_type')
    ...
    models = {
        ...
        'timing.experiment': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'url_slug': ('django.db.models.fields.SlugField', [], {'default': "'thjtf'", 'unique': 'True', 'max_length': '10'}),
        ...
        'timing.participant': {
            ...
            'participant_number': ('django.db.models.fields.CharField', [], {'default': "'128816'", 'unique': 'True', 'max_length': '8'}),
        ...
        'timing.response': {
            ...
            'prompt_type': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
