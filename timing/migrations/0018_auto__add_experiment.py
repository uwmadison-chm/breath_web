...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('timing_experiment', (
            ...
            ('url_slug', self.gf('django.db.models.fields.SlugField')(default='7cns', unique=True, max_length=10, db_index=True)),
            ('run_length_seconds', self.gf('django.db.models.fields.IntegerField')(default=900)),
            ('chime_on_error', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('timing', ['Experiment'])


    def backwards(self, orm):
        
        # Deleting model 'Experiment'
        db.delete_table('timing_experiment')
    ...
    models = {
        ...
        'timing.experiment': {
            ...
            'scm_revision': ('django.db.models.fields.CharField', [], {'default': "'.'", 'max_length': '255'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'url_slug': ('django.db.models.fields.SlugField', [], {'default': "'FRdm'", 'unique': 'True', 'max_length': '10', 'db_index': 'True'})
        },
        'timing.gender': {
        ...
        'timing.participant': {
            ...
            'participant_number': ('django.db.models.fields.CharField', [], {'default': "'753739'", 'unique': 'True', 'max_length': '8'}),
