...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Experiment.survey_url'
        db.add_column('timing_experiment', 'survey_url', self.gf('django.db.models.fields.URLField')(default='http://example.com', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Experiment.survey_url'
        db.delete_column('timing_experiment', 'survey_url')
    ...
    models = {
        ...
        'timing.experiment': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'url_slug': ('django.db.models.fields.SlugField', [], {'default': "'fshcn'", 'unique': 'True', 'max_length': '10', 'db_index': 'True'})
        },
        'timing.gender': {
        ...
        'timing.participant': {
            ...
            'participant_number': ('django.db.models.fields.CharField', [], {'default': "'560073'", 'unique': 'True', 'max_length': '8'}),
