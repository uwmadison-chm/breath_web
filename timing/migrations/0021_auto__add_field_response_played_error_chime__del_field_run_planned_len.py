...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Response.played_error_chime'
        db.add_column('timing_response', 'played_error_chime', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Run.planned_length_sec'
        db.delete_column('timing_run', 'planned_length_sec')

        # Adding field 'Run.experiment'
        db.add_column('timing_run', 'experiment', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['timing.Experiment']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Response.played_error_chime'
        db.delete_column('timing_response', 'played_error_chime')
        ...
        # Deleting field 'Run.experiment'
        db.delete_column('timing_run', 'experiment_id')
    ...
    models = {
        ...
        'timing.experiment': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'url_slug': ('django.db.models.fields.SlugField', [], {'default': "'qbczn'", 'unique': 'True', 'max_length': '10', 'db_index': 'True'})
        },
        'timing.gender': {
        ...
        'timing.participant': {
            ...
            'participant_number': ('django.db.models.fields.CharField', [], {'default': "'723830'", 'unique': 'True', 'max_length': '8'}),
