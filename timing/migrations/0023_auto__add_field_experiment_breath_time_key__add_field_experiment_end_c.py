...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Experiment.breath_time_key'
        db.add_column('timing_experiment', 'breath_time_key', self.gf('django.db.models.fields.CharField')(default='A', max_length=1), keep_default=False)

        # Adding field 'Experiment.end_cycle_key'
        db.add_column('timing_experiment', 'end_cycle_key', self.gf('django.db.models.fields.CharField')(default='F', max_length=1), keep_default=False)

        # Adding field 'Experiment.cycle_length'
        db.add_column('timing_experiment', 'cycle_length', self.gf('django.db.models.fields.IntegerField')(default=9), keep_default=False)

        # Adding field 'Experiment.practice_cycles'
        db.add_column('timing_experiment', 'practice_cycles', self.gf('django.db.models.fields.FloatField')(default=1.5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Experiment.breath_time_key'
        db.delete_column('timing_experiment', 'breath_time_key')

        # Deleting field 'Experiment.end_cycle_key'
        db.delete_column('timing_experiment', 'end_cycle_key')

        # Deleting field 'Experiment.cycle_length'
        db.delete_column('timing_experiment', 'cycle_length')

        # Deleting field 'Experiment.practice_cycles'
        db.delete_column('timing_experiment', 'practice_cycles')
    ...
    models = {
        ...
        'timing.experiment': {
            ...
            'breath_time_key': ('django.db.models.fields.CharField', [], {'default': "'A'", 'max_length': '1'}),
            ...
            'end_cycle_key': ('django.db.models.fields.CharField', [], {'default': "'F'", 'max_length': '1'}),
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'url_slug': ('django.db.models.fields.SlugField', [], {'default': "'hdhjt'", 'unique': 'True', 'max_length': '10', 'db_index': 'True'})
        },
        'timing.gender': {
        ...
        'timing.participant': {
            ...
            'participant_number': ('django.db.models.fields.CharField', [], {'default': "'675561'", 'unique': 'True', 'max_length': '8'}),
