...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Participant.email_ok'
        db.add_column('timing_participant', 'email_ok', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Participant.email_ok'
        db.delete_column('timing_participant', 'email_ok')
    ...
    models = {
        ...
        'timing.participant': {
            ...
            'participant_number': ('django.db.models.fields.CharField', [], {'default': "'520198'", 'unique': 'True', 'max_length': '8'}),
