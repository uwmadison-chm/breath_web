...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Run.user_agent'
        db.add_column('timing_run', 'user_agent', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Run.user_agent'
        db.delete_column('timing_run', 'user_agent')
    ...
    models = {
        ...
        'timing.participant': {
            ...
            'participant_number': ('django.db.models.fields.CharField', [], {'default': "'959624'", 'unique': 'True', 'max_length': '8'}),
