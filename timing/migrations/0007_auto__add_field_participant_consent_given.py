...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Participant.consent_given'
        db.add_column('timing_participant', 'consent_given', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Participant.consent_given'
        db.delete_column('timing_participant', 'consent_given')
    ...
    models = {
        ...
        'timing.participant': {
            ...
            'participant_number': ('django.db.models.fields.CharField', [], {'default': "'211183'", 'unique': 'True', 'max_length': '8'}),
